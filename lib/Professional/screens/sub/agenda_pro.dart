...
class AgendaProView extends StatefulWidget {
  ...
  static Widget get({
    ...
    return BlocProvider(
      ...
      child: AgendaProView._(professional),
    );
  }

  const AgendaProView._(this.professional);
  @override
  State<AgendaProView> createState() => _AgendaProViewState();
}

class _AgendaProViewState extends State<AgendaProView> {
    ...
    return Column(spacing: 16, children: <Widget>[
      ...
      Expanded(
          child: AutoListView.get<Agenda>(
              ...
              shrinkWrap: true,
              itemBuilder: (context, agenda) =>
                  AgendaItem(professional: widget.professional, agenda: agenda),
